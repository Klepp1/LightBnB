...
const getAllReservations = function(guest_id, limit = 10) {
  let user;
  return pool
  .query(`SELECT properties.number_of_bedrooms, properties.parking_spaces, properties.thumbnail_photo_url, properties.number_of_bathrooms, reservations.id, properties.title, properties.cost_per_night, reservations.start_date, avg(rating) as average_rating
  FROM reservations
